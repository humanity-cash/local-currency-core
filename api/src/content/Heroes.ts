...
export const Heroes: HomeScreenContent[] = [
  {
    contentType: "Heroes",
    image: "https://berkshares-images.imgix.net/BerkShare_1-front.jpg?w=512",
  ...
  {
    contentType: "Heroes",
    image: "https://berkshares-images.imgix.net/BerkShare_5-front.jpg?w=512",
    textTitle: "W. E. B. Du Bois",
    text: "Sociologist and civil rights pioneer committed to the freedom and equality of all peoples. Born in Great Barrington in 1868, Du Bois' activities contributed to the formation of the National Association for the Advancement of Colored People. For twenty-five years he served as editor of the NAACP Magazine, The Crisis. Today, Du Bois' boyhood homesite in the Berkshires is dedicated as a National Historic Landmark.",
  },
  {
    contentType: "Heroes",
    image: "https://berkshares-images.imgix.net/BerkShare_50-front.jpg?w=512",
  ...
  {
    contentType: "Heroes",
    image: "https://berkshares-images.imgix.net/BerkShare_20-front.jpg?w=512",
  ...
  {
    contentType: "Heroes",
    image: "https://berkshares-images.imgix.net/BerkShare_10-front.jpg?w=512",
    links: [
      {
