...
import { getFundingStatus, getDeposits, getWithdrawals, getTransfers } from "src/service/PublicService";
import { httpUtils } from "src/utils";
import { IDeposit, IWithdrawal, IOperatorTotal, ITransferEvent } from "src/types";
...
export async function getAllWithdrawals(req: Request, res: Response): Promise<void> {
  try {
...
export async function getOperatorStatistics(req: Request, res: Response): Promise<void> {
  try {
...
export async function getAllTransfers(req: Request, res: Response): Promise<void> {
  try {
