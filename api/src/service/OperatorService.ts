  ...
  return Promise.all(
    transfers.map(async function (t) {
      ...
      if (fromIsCommunityChest) {
        ...
        fromName = t.isRedemptionFee ? textUtils.HUMANITY_CASH_REDEMPTION_FEE_DISPLAY_NAME : textUtils.HUMANITY_CASH_DISPLAY_NAME;
        fromDwollaUserId = "";
      } else {
      ...
      if (toIsCommunityChest) {
        ...
        toName = t.isRedemptionFee? textUtils.HUMANITY_CASH_REDEMPTION_FEE_DISPLAY_NAME : textUtils.HUMANITY_CASH_DISPLAY_NAME;
        toDwollaUserId = "";
      } else {
